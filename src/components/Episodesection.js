...
function Episodesection({ data, id, progress, setUrl }) {
  ...
  return (
    <div className={styles.episodesection}>
      <div className={`${styles.eptopsection} flex-wrap sm:flex-nowrap px-1 sm:px-2`}>
        <div className={styles.epleft}>
          <div className={styles.cardhead}>
            <span className={styles.bar}></span>
            <h1 className={`${styles.headtitle} text-sm sm:text-base`}>Episodes</h1>
          </div>
          {data?.status !== 'NOT_YET_RELEASED' && data?.type !== 'MANGA' &&
            <Tooltip content="Refresh Episodes">
              <button className={styles.refresh} onClick={refreshEpisodes}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-[18px] h-[18px] sm:w-[22px] sm:h-[22px] ${loading ? "animate-spin" : ""}`}>
        ...
        {!loading && <>
          {<>
            <div className={`${styles.epright} hidden md:flex`}>
              <div className={`${styles.selects} flex flex-wrap sm:flex-nowrap gap-1 sm:gap-0`}>
                  {totalEpisodes > 100 && (
                    <div className="flex flex-col w-[110px] sm:w-[120px] mr-1 sm:mr-2">
                      <Select
                        label=""
                  ...
                  <div className="flex w-[125px] sm:w-[133px] flex-col gap-2 mr-2 sm:mr-3">
                    <Select
                      label=""
                      aria-label="Switch"
                      placeholder={`Switch`}
                      ...
                      classNames={{
                        base: "!m-0 !p-0 ",
                        mainWrapper: "p-0 m-0 h-[34px]",
                        trigger: "m-0 !min-h-[34px] !max-w-[120px] sm:!max-w-[128px] pr-0",
                        value: "",
                        listbox: "m-0 p-0",
                      }}
                      radius="sm"
                ...
                <div className="flex w-[70px] sm:w-[75px] flex-col gap-2 mr-1 sm:mr-2">
                  {/* SUB/DUB selection removed */}
                </div>
              </div>
              <div className={styles.epchangeicons}>
                <div className={styles.epchangeopt}>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={`${eplisttype === 1 ? '#1a365d' : 'currentColor'}`} className="w-5 h-5 sm:w-6 sm:h-6">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={`${eplisttype === 2 ? '#1a365d' : 'currentColor'}`} className="w-5 h-5 sm:w-6 sm:h-6">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={`${eplisttype === 3 ? '#1a365d' : 'currentColor'}`} className="w-5 h-5 sm:w-6 sm:h-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
                    </svg>
                  </span>
                </div>
                <button className={styles.refresh} onClick={reverseOrder}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-[18px] h-[18px] sm:w-[22px] sm:h-[22px]">
            ...
            <div className="flex md:hidden ml-auto items-center">
              <div className={styles.epchangeopt}>
                <span
                  className={`mx-[4px] cursor-pointer ${eplisttype === 1 ? 'selected' : ''}`}
                  onClick={() => handleOptionClick(1)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={`${eplisttype === 1 ? '#1a365d' : 'currentColor'}`} className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
                  </svg>
                </span>
                <span
                  className={`mx-[4px] cursor-pointer ${eplisttype === 2 ? 'selected' : ''}`}
                  onClick={() => handleOptionClick(2)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={`${eplisttype === 2 ? '#1a365d' : 'currentColor'}`} className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
                  </svg>
                </span>
                <span
                  className={`mx-[4px] cursor-pointer ${eplisttype === 3 ? 'selected' : ''}`}
                  onClick={() => handleOptionClick(3)}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke={`${eplisttype === 3 ? '#1a365d' : 'currentColor'}`} className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
                  </svg>
                </span>
              </div>
              <button className="ml-2 mr-2" onClick={reverseOrder}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-[18px] h-[18px]">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                </svg>
              </button>
              <span className="cursor-pointer" onClick={toggleShowSelect}>
      ...
      {showSelect && (
        <div className={`${styles.selectmobile} p-3 gap-2 flex-wrap justify-center`}>
            ...
            <div className="flex flex-col w-[110px]">
              <Select
                ...
                classNames={{
                  base: "!m-0 !p-0",
                  mainWrapper: "p-0 m-0 h-[34px]",
                  trigger: "m-0 !min-h-[34px] !max-w-[105px] pr-0",
                  value: "",
                  listbox: "m-0 p-0",
                }}
                radius="sm"
          ...
          <div className="flex w-[125px] flex-col gap-2">
            <Select
              ...
              classNames={{
                base: "!m-0 !p-0",
                mainWrapper: "p-0 m-0 h-[34px]",
                trigger: "m-0 !min-h-[34px] !max-w-[120px] pr-0",
                value: "",
                listbox: "m-0 p-0",
              }}
              radius="sm"
      ...
      {loading && (
        <>
          {data?.type === 'MANGA' ? (
            <div className="text-[15px] sm:text-[17px] font-semibold">
              <p className="text-center mt-3 sm:mt-4">Coming Soon! </p>
              <p className="text-center mb-3 sm:mb-4">Cannot Fetch Manga, Feature Coming Soon.</p>
            </div>
          ) : data?.status === 'NOT_YET_RELEASED' ? (
            <div className="text-[15px] sm:text-[17px] font-semibold">
              <p className="text-center mt-3 sm:mt-4">Coming Soon! </p>
              <p className="text-center mb-3 sm:mb-4">Sorry, this anime isn't out yet. Keep an eye out for updates!</p>
            </div>

          ) : (
            <div className="text-[15px] sm:text-[17px] font-semibold">
              <p className="text-center mt-3 sm:mt-4 mb-1">Please Wait... </p>
              <p className="text-center mb-3 sm:mb-4">Loading Episode Data</p>
            </div>
          )}
        </>
      )}
      ...
      {!loading && !filteredEpisodes && (
        <div className="text-[15px] sm:text-[17px] font-semibold">
          <p className="text-center mt-3 sm:mt-4">Oh no! </p>
          <p className="text-center mb-3 sm:mb-4">This anime is currently unavailable. Check back later for updates!</p>
        </div>
      )}
      {!loading && (
        <>
