                    ...
                    <div className="lg:flex lg:justify-between">
                        <div className="mb-8 lg:mb-0">
                            ...
                            <div className="flex gap-4 mb-4">
                                <Link href="https://instagram.com/its.dark.devil" target="_blank" className="text-[#999] hover:text-white transition-colors">
                                ...
                                <Link href="https://discord.gg/aR6mmjfZVK" target="_blank" className="text-[#999] hover:text-white transition-colors">
