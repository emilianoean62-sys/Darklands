    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          SkyAnime is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on SkyAnime are hosted on our servers. All
          links point to content hosted on third-party websites. SkyAnime does
          ...
          to{" "}
          <Link href="mailto:contact@skyanime.com" className="text-white">
            contact@skyanime.com
          </Link>{" "}
