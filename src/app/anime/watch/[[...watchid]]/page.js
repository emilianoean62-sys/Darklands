...
async function AnimeWatch({ params, searchParams }) {
  ...
  return (
    <>
        <Navbarcomponent />
      <div className="bg-black w-full flex flex-col lg:flex-row lg:max-w-[98%] mx-auto xl:max-w-[94%] lg:gap-[6px] mt-[70px] min-h-screen pb-10">
        ...
        <div className="lg:hidden">
        <Animecards data={data?.recommendations?.nodes} cardid={"Recommendations"} style={{backgroundColor: '#000000'}}/>
        </div>
      </div>
    </>
  );
